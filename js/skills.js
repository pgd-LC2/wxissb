...
function generateAllSkills(baseBladeSkills = []) {
  ...
  skills.push({ name:"电磁脉冲", description:"每8秒释放电磁脉冲，使周围敌人减速50%持续2秒", tier:2, icon:"wifi.exclamationmark", effect:(s)=>{ s.empPulseEnabled = true; s.empPulseInterval = 8; s.empPulseSlowRate = 0.5; s.empPulseDuration = 2.0; }});
