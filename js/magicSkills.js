...
(() => {
  ...
  function generateMagicSkills() {
    ...
    const curseSkills = [
      ...
      { name: "灵魂烙印", tier: 2, desc: "标记敌人，死亡时引发连锁爆炸伤害周围敌人",
        effect: g => { g.magic.soulBrand = true; g.magic.soulBrandExplosionRadius = 60; g.magic.soulBrandDamage = 40; }},
    ...
    const barrierSkills = [
      ...
      { name: "雷霆领域", tier: 3, desc: "创建雷霆领域，领域内敌人持续受到雷击并降低移速",
        effect: g => { g.magic.thunderDomainEnabled = true; g.magic.thunderDomainDamage = 15; g.magic.thunderDomainSlow = 0.40; }},
      ...
      { name: "衰弱领域", tier: 3, desc: "创建衰弱领域，领域内敌人攻击力和防御力大幅下降",
        effect: g => { g.magic.weakenDomainEnabled = true; g.magic.weakenDomainAttackReduction = 0.35; g.magic.weakenDomainDefenseReduction = 0.25; }},
